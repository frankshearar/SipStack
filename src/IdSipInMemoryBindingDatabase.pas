...
unit IdSipInMemoryBindingDatabase;
...
type
  ...
  TIdSipInMemoryBindingDatabase = class(TIdSipAbstractBindingDatabase)
  private
  ...
  TIdSipNameMatchingMockBindingDatabase = class(TIdSipInMemoryBindingDatabase)
  protected
    function CollectBindingsFor(const AddressOfRecord: String;
                                Bindings: TIdSipContacts;
                                CollectGruus: Boolean): Boolean; override;
...
//******************************************************************************
//* TIdSipInMemoryBindingDatabase                                              *
//******************************************************************************
//* TIdSipInMemoryBindingDatabase Public methods *******************************

constructor TIdSipInMemoryBindingDatabase.Create;
begin
  inherited Create;
...
destructor TIdSipInMemoryBindingDatabase.Destroy;
begin
  Self.Lock.Acquire;
  try
...
function TIdSipInMemoryBindingDatabase.BindingCount: Integer;
begin
  Self.Lock.Acquire;
  try
...
function TIdSipInMemoryBindingDatabase.IsAuthorized(User: TIdSipAddressHeader;
...
function TIdSipInMemoryBindingDatabase.IsValid(Request: TIdSipRequest): Boolean;
begin
  Self.Lock.Acquire;
  try
...
function TIdSipInMemoryBindingDatabase.RemoveBinding(Request: TIdSipRequest;
...
function TIdSipInMemoryBindingDatabase.UpdateBinding(Request: TIdSipRequest;
                                                 Contact: TIdSipContactHeader): Boolean;
...
//* TIdSipInMemoryBindingDatabase Protected methods ****************************

function TIdSipInMemoryBindingDatabase.AddBinding(const AddressOfRecord: String;
                                              Contact: TIdSipContactHeader;
                                              const CallID: String;
                                              SequenceNo: Cardinal;
...
function TIdSipInMemoryBindingDatabase.Binding(const AddressOfRecord: String;
...
function TIdSipInMemoryBindingDatabase.CollectBindingsFor(const AddressOfRecord: String;
                                                      Bindings: TIdSipContacts;
...
function TIdSipInMemoryBindingDatabase.CollectBindingsForUsing(const AddressOfRecord: String;
                                                           Bindings: TIdSipContacts;
                                                           CollectGruus: Boolean;
                                                           MatchingFunction: TIdSipMatchingFunction): Boolean;
var
...
procedure TIdSipInMemoryBindingDatabase.Commit;
begin
end;

procedure TIdSipInMemoryBindingDatabase.Rollback;
begin
end;

procedure TIdSipInMemoryBindingDatabase.StartTransaction;
begin
end;

//* TIdSipInMemoryBindingDatabase Private methods ******************************

procedure TIdSipInMemoryBindingDatabase.DeleteBinding(Index: Integer);
begin
  if (Index >= 0) then
    Self.BindingStore.Delete(Index);
end;

function TIdSipInMemoryBindingDatabase.GetBindings(Index: Integer): TIdRegistrarBinding;
begin
  Result := Self.BindingStore[Index] as TIdRegistrarBinding;
end;

function TIdSipInMemoryBindingDatabase.IndexOfBinding(const AddressOfRecord: String;
                                                  Contact: TIdSipContactHeader): Integer;
begin
  Result := 0;
