...
type
  ...
  public
    ...
    procedure AddConnection(Closure: TIdSipTcpConnectionOpenWait); overload;
...
begin
  ...
  try
    ...
    Self.AddConnection(SimulatedEvent);
  finally
    SimulatedEvent.Free;
  end;
end;

procedure TIdSipTCPTransport.AddConnection(Closure: TIdSipTcpConnectionOpenWait);
var
