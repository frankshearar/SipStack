...
type
  ...
  protected
    ...
    procedure EstablishDialog(const R: TIdSipResponse; const T: TIdSipAbstractTransport);
  public
...
procedure TIdSipClientInviteTransaction.EstablishDialog(const R: TIdSipResponse; const T: TIdSipAbstractTransport);
var
  Dialog:   TIdSipDialog;
  ID:       TIdSipDialogID;
